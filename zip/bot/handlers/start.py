    ...
    async with AsyncSessionFactory() as session:
        ...
        if kind == "guide":
            ...
            if episode and user:
                ...
                from bot.utils.formatting import episode_guide_text

                await message.answer(
                    episode_guide_text(episode, sorted(episode.choices, key=lambda item: item.order_index), user.spoiler_level),
